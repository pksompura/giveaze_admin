...
const FundraisingBanner = () => {
  ...
  return (
    <div className="bg-orange-200 w-full md:w-[80%] mx-auto rounded-lg my-4  flex flex-col md:flex-row items-center justify-between p-6 md:p-12">
      <div className="md:w-1/2">
        ...
        <div className="flex flex-col md:flex-row">
          <button className="bg-orange-500 text-white px-6 py-2 rounded-full mb-2 md:mb-0 md:mr-4"   
          //  onClick={handleOpen}
           >
