...
//                     dataIndex: "amount",
//                     render: (a) =>
//                       typeof a === "object" && a.$numberDecimal
//                         ? Number(a.$numberDecimal).toFixed(2) // format with 2 decimals if needed
//                         : a,
//                   },
//                   {
//                     title: "Status",
...
//                         {typeof w.amount === "object" && w.amount.$numberDecimal
//                           ? Number(w.amount.$numberDecimal).toFixed(2)
//                           : w.amount}
//                       </p>
          ...
          },
          {
            ...
            render: (_, record) => (
              <Space>
                <Button
                  type="primary"
                  onClick={() => handleBankStatus(record._id, "Approved")}
                >
                  Approve
                </Button>
                <Button
                  danger
                  onClick={() => handleBankStatus(record._id, "Rejected")}
                >
                  Reject
                </Button>
              </Space>
        ...
        columns={[
          {
            ...
            render: (a) =>
              typeof a === "object" && a.$numberDecimal
                ? Number(a.$numberDecimal).toFixed(2)
                : a,
          },
          {
            title: "Status",
          ...
          },
          {
            ...
            render: (_, record) => (
              <Space>
                ...
                <Button
                  danger
                  onClick={() => handleWithdrawalStatus(record._id, "Rejected")}
                >
                  Reject
                </Button>
              </Space>
            ...
            <Card>
              ...
              <Space>
                <Button
                  type="primary"
                  size="small"
                  onClick={() => handleWithdrawalStatus(w._id, "Completed")}
                >
                  Approve
                </Button>
                <Button
      ...
      <Card style={{ marginBottom: 20 }}>
        {isLoading ? (
          ...
          <Descriptions bordered column={1}>
            ...
            <Descriptions.Item label="Raised">
              ₹
              {campaign?.raised_amount?.$numberDecimal ||
      ...
      {isMobile ? (
        <>
          <Segmented
            ...
            options={["Beneficiary", "Bank Accounts", "Withdrawals"]}
            style={{ marginBottom: 16 }}
          />
          {activeTab === "Beneficiary" && <BeneficiaryCard />}
        ...
        <Tabs
          defaultActiveKey="1"
          items={[
            { key: "1", label: "Beneficiary", children: <BeneficiaryCard /> },
            { key: "2", label: "Bank Accounts", children: <BankAccounts /> },
            { key: "3", label: "Withdrawals", children: <Withdrawals /> },
          ]}
        />
      )}
    </div>
